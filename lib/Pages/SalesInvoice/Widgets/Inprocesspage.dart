...
class InProcessPageSales extends StatefulWidget {
  const InProcessPageSales(
      {Key? key,
      required this.theme,
  ...
  @override
  State<InProcessPageSales> createState() => _InProcessPageSalesState();
}

class _InProcessPageSalesState extends State<InProcessPageSales> {
  @override
                         ...
                         showDialog<dynamic>(
                              ...
                              builder: (_) {
                               ...
                               // context.read<SalesTabController>().resetValues();
                                return FollowDialogSales( index: i,leadOpenAllData:widget.InProcessAllData[i]);
                              }).then((value) {
                                setState(() {
