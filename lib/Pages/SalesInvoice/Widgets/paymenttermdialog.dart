...
class paytermdialogSales extends StatefulWidget {
  paytermdialogSales({super.key, required this.paymode});
  final PaymodeModalData? paymode;
  @override
  State<paytermdialogSales> createState() => _paytermdialogSalesState();
}

class _paytermdialogSalesState extends State<paytermdialogSales> {
