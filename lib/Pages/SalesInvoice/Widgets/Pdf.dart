...
class pdfSales extends StatefulWidget {
  const pdfSales({Key? key}) : super(key: key);

  @override
  State<pdfSales> createState() => pdfSalesState();
}

class pdfSalesState extends State<pdfSales> {
