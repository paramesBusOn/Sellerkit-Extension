...
class ShowSearchDialogSales extends StatefulWidget {
  ShowSearchDialogSales({Key? key}) : super(key: key);
  @override
  State<ShowSearchDialogSales> createState() => ShowSearchDialogSalesState();
}

class ShowSearchDialogSalesState extends State<ShowSearchDialogSales> {
  @override
