...
import 'package:sellerkit/Pages/SalesInvoice/Widgets/OpenOrder.dart';
import 'package:sellerkit/Pages/SalesInvoice/Widgets/WonOrderPage.dart';


class SearhBoxSales extends StatefulWidget {
  SearhBoxSales({
    Key? key,
    required this.theme,
  ...
  @override
  State<SearhBoxSales> createState() => SearhBoxState();
}

class SearhBoxState extends State<SearhBoxSales> with TickerProviderStateMixin {
        ...
        content: SizedBox(
          ...
          child: context.watch<SalesTabController>().datagotByApi == true &&
                                    ...
                                    children: [
                                      ...
                                      InProcessPageSales(
                                        ...
                                        leadSummaryinprocess:
                                            context.read<SalesTabController>().getleadSummaryinprocess,
              ...
              : context.watch<SalesTabController>().datagotByApi == true &&
                  ...
                  : context.watch<SalesTabController>().datagotByApi ==
                              false &&
                          context
                              .watch<SalesTabController>()
                              .getLeadCheckDataExcep
