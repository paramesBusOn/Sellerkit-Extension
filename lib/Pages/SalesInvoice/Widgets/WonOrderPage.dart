...
class WonSalesPage extends StatefulWidget {
  const WonSalesPage(
      {Key? key,
      required this.theme,
  ...
  @override
  State<WonSalesPage> createState() => _WonSalesPageState();
}

class _WonSalesPageState extends State<WonSalesPage> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
       widget.leadSummaryWon.isEmpty?Container():   Card(
         child: Container(
                         ...
                         showDialog<dynamic>(
                              ...
                              builder: (_) {
                               ...
                               // context.read<SalesTabController>().resetValues();
                                return FollowDialogSales( index: i,leadOpenAllData:widget.leadWonAllData[i]);
                              }).then((value) {
                                setState(() {
