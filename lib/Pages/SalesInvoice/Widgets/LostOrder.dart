...
class LostOrderPageSales extends StatefulWidget {
  const LostOrderPageSales(
      {Key? key,
      required this.theme,
  ...
  @override
  State<LostOrderPageSales> createState() => _LostOrderPageSalesState();
}

class _LostOrderPageSalesState extends State<LostOrderPageSales> {
  @override
                  ...
                  children: [
                    SizedBox(
                        ...
                        child: Text(
                          ...
                          //  context.read<SalesTabController>().config.
