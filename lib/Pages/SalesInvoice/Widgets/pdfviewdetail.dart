...
class pdfviewSales extends StatefulWidget {
  const pdfviewSales({Key? key}) : super(key: key);

  @override
  State<pdfviewSales> createState() => pdfviewSalesState();
}

class pdfviewSalesState extends State<pdfviewSales> {
...
static customerdetData? customermodeldata;
  ...
  void initState() {
    ...
    setState(() {
      ...
      log("orderMasterdata::${data2!.length}");
