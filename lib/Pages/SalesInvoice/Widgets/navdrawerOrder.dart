...
class navDrawerSales extends StatefulWidget {
  const navDrawerSales({Key? key}) : super(key: key);

  @override
  State<navDrawerSales> createState() => _navDrawerSalesState();
}

class _navDrawerSalesState extends State<navDrawerSales> {
             ...
             child: Container(
                 ...
                 child: Column(
                   ...
                   children: [
                     ...
                     child: Text("Order Filters",style: theme.textTheme.bodyText2!.copyWith(color: theme.primaryColor,fontWeight: FontWeight.bold,
                     fontSize: 15),),
                    ),
                               Container(
                                 width: Screens.width(context),
