...
class WarningDialogSales extends StatefulWidget {
  WarningDialogSales({
    Key? key,
  }) : super(key: key);
  
  @override
  State<WarningDialogSales> createState() => AssignedToDialogUserState();
}

class AssignedToDialogUserState extends State<WarningDialogSales> {
