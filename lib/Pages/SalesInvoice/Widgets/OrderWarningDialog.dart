...
class SalesWarningDialog extends StatefulWidget {
  SalesWarningDialog({Key? key, }) : super(key: key);
  @override
  State<SalesWarningDialog> createState() => SalesWarningDialogState();
}

class SalesWarningDialogState extends State<SalesWarningDialog> {
