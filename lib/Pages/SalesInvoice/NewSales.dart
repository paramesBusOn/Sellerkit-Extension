...
class SalesBookNew extends StatefulWidget {
  SalesBookNew({super.key});

  @override
  State<SalesBookNew> createState() => SalesBookNewState();
}

class SalesBookNewState extends State<SalesBookNew> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          // body: ChangeNotifierProvider<SalesNewController>(
          //     create: (context) => SalesNewController(),
          //     builder: (context, child) {
          //       return Consumer<SalesNewController>(
          //           builder: (BuildContext context, provi, Widget? child) {
          // return
          body: PageView(
            physics: new NeverScrollableScrollPhysics(),
            controller: context.read<SalesNewController>().pageController,
            onPageChanged: (index) {
              log("index: ${index}");
              setState(() {
                context.read<SalesNewController>().pageChanged = index;
              });
              print(context.read<SalesNewController>().pageChanged);
            },
            children: [
              GestureDetector(
                onTap: () {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Form(
                key: context.read<SalesNewController>().formkey[1],
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    context.watch<SalesNewController>().paymentTerm == false
                        ? Container()
                        : Text(
                            "Enter Payment Terms",
                    ...
                    Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              context.read<SalesNewController>().files == null
                                  ? Container(
            ...
            Column(
              children: [
           context.read<SalesNewController>(). postpaymentdata.isEmpty?Container():     Container(
                  width: Screens.width(context),
                  ...
                  child: ListView.builder(
                    itemCount:context.read<SalesNewController>(). postpaymentdata.length,
                             ...
                             mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                  ...
                                  child: Row(
                                    children: [
                                      Container(
                                        ...
                                        child:Text("${context.read<SalesNewController>(). postpaymentdata[ind].paymodename}", style: theme.textTheme.bodyText1?.copyWith(
                                                              ))
                                      ),
                                   Container(
                                ...
                                Container(
                                  ...
                                  child:Text(" ${context.read<SalesNewController>().config.slpitCurrency22(context.read<SalesNewController>(). postpaymentdata[ind].amount.toString())}",
                                ...
                                Container(
                                  ...
                                  child:InkWell(
                                    onTap:(){
                                      setState(() {
                                       context.read<SalesNewController>(). deletepaymode(context.read<SalesNewController>(). postpaymentdata[ind],ind );
                                        context.read<SalesNewController>(). postpaymentdata.removeAt(ind);
                                      });
              ...
              height: Screens.bodyheight(context) * 0.01,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                          "Total Order Value Rs.${context.read<SalesNewController>().getTotalGrossAmount()}",
                          maxLines: 8,
                          overflow: TextOverflow.ellipsis,
                          style: theme.textTheme.bodyText1?.copyWith(
                            color: theme.primaryColor,
  ...
  Container GetAttachment(ThemeData theme, BuildContext context) {
    return Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          context.read<SalesNewController>().files2 == null
              ? Container(
                  height: Screens.padingHeight(context) * 0.3,
                  padding: EdgeInsets.only(
              ...
              : Container(
                  height:
                      context.read<SalesNewController>().files2.length == 0
                          ? Screens.padingHeight(context) * 0.0
                  ...
                  child: ListView.builder(
                      itemCount:
                          context.read<SalesNewController>().files2.length,
  ...
  Container SecondPage(
    ...
    //  return ChangeNotifierProvider<SalesNewController>(
    //       create: (context) => SalesNewController(),
    //       builder: (context, child) {
    //         return Consumer<SalesNewController>(
    //           builder: (BuildContext context, provi, Widget? child) {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Container(
                width: context.read<SalesNewController>().showItemList == true
                ...
                child: TextField(
                  ...
                  controller:
                      context.read<SalesNewController>().mycontroller[12],
                  decoration: InputDecoration(
                    filled: false,
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () {
                        ...
                        context.read<SalesNewController>().changeVisible();
                      }, //
                      color: theme.primaryColor,
                    ),
              ...
              context.read<SalesNewController>().showItemList == true
                  ? Container(
                      // alignment: Alignment.center,
                      child: IconButton(
                          onPressed: () {
                            setState(() {
                              context.read<SalesNewController>().scannerreset();
                              ...
                              Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (_) => qrscanner()))
//                 .then((value){
// return context.read<SalesNewController>().scanneddataget(context);
//                 }
//                  )
                                  ;
                            });
                                ...
                                Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      width: Screens.width(context) * 0.4,
                                      child: Text(
                                          "${context.read<SalesNewController>().getAllProductDetails[i].itemName}",
                                          style: theme.textTheme.bodyText1
                                              ?.copyWith(
                                                  //color: theme.primaryColor
                                                  )),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            "${context.read<SalesNewController>().config.slpitCurrency22(context.read<SalesNewController>().getAllProductDetails[i].sp.toString())}",
                                            style: theme.textTheme.bodyText1
                                                ?.copyWith(
                                                    color: theme.primaryColor),
                                          ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                                "${context.read<SalesNewController>().getTotalOrderAmount()}",
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 15.0,
                                )),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            width: Screens.width(context) * 0.32,
                            child: Text(
                                "${context.read<SalesNewController>().getTotalTaxAmount()}",
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 15.0,
                                )),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            width: Screens.width(context) * 0.32,
                            child: Text(
                                "${context.read<SalesNewController>().getTotalGrossAmount()}",
                                style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 15.0,
                                )),
                ...
                child: ElevatedButton(
                    onPressed: () {
                      context
                          ...
                          .pageController
                          .animateToPage(
                              --context.read<SalesNewController>().pageChanged,
                              duration: Duration(milliseconds: 250),
                              curve: Curves.bounceIn);
                    },
                    child: Icon(Icons.keyboard_arrow_left)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () {
                      ...
                      context.read<SalesNewController>().seconPageBtnClicked();
                      log("oldcutomer: " +
                          context
                              .read<SalesNewController>()
                              .oldcutomer
  ...
  InkWell FirstPage(
    ...
    return InkWell(
      ...
      child: (context
                  ...
                  .isEmpty &&
              context.read<SalesNewController>().getcustomerapicLoading == true)
          ? Center(
              child: CircularProgressIndicator(),
            )
          : (context
                      ...
                      .getexceptionOnApiCall
                      .isNotEmpty &&
                  context.read<SalesNewController>().getcustomerapicLoading ==
                      false)
              ? Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
...
//Ship
                          ...
                          //     ),
                          //     Text(
                          //       context.read<SalesNewController>().validateAge ==
                          //               true
                          //           ? "Age Group *"
                          //           : "Age Group",
                          //       style: context
  ...
  //     context.read<SalesNewController>().getenqReffList.length,
  //     (index) => InkWell(
  //       onTap: () {
  //         // context.read<NewEnqController>(). isSelectedenquirytype = context.read<NewEnqController>()
  //         // .getenqReffList[index].Name.toString();
  //         context.read<SalesNewController>().selectEnqReffers(
  //             context
  //                 .read<SalesNewController>()
  //                 .getenqReffList[index]
  //                 .Name
  //                 .toString(),
  //             context.read<SalesNewController>().getenqReffList[index].Name!,
  //             context.read<SalesNewController>().getenqReffList[index].Code!);
  //       },
  //       child: Container(
  //         width: Screens.width(context) * 0.4,
  //         height: Screens.bodyheight(context) * 0.06,
      ...
      (index) => InkWell(
        ...
        child: Stack(
         ...
         Positioned(
          ...
          left:Screens.width(context)*0.01,
          child: context.read<SalesNewController>().paymode[index].amount !=null && context.read<SalesNewController>().paymode[index].amount !=""?Text("${context.read<SalesNewController>().paymode[index].ModeName}",style:theme.textTheme.bodyText1?.copyWith(color:theme.primaryColor,fontSize: 10)):Text("")
          )
      //  Positioned(
      //     top: Screens.padingHeight(context)*0.005,
      //     left:Screens.width(context)*0.01,
