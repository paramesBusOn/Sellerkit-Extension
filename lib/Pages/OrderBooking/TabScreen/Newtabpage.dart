...
import 'package:sellerkit/Pages/OrderBooking/TabScreen/BillingTabScreen.dart';
...
class NewOrdersTabPage extends StatefulWidget {
  NewOrdersTabPage({Key? key}) : super(key: key);

  @override
  State<NewOrdersTabPage> createState() => LeadsTabState();
}

class LeadsTabState extends State<NewOrdersTabPage>
            ...
            SizedBox(
                ...
                child: SingleChildScrollView(
                  child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    SOSearchWidget(
                      searchHeight: Screens.bodyheight(context) * 0.93,
                  ...
                  children: [
                    ...
                    // //     : 
                        POCustomerDetails(
                            ...
                            custHeight: Screens.bodyheight(context) * 0.4,
                            theme: theme,
                          ),
                    ...
                    // //     :
                         POCashWidget(
                            ...
                            cashHeight: Screens.bodyheight(context) * 0.25,
                            theme: theme,
                          ),
                    SOBottomButtons(
                      theme: theme,
