...
import 'package:sellerkit/Pages/SalesInvoice/Widgets/paymenttermdialog.dart';
import 'package:sellerkit/Pages/SalesInvoice/Widgets/pos-widget/AlertBox.dart';
import 'package:sellerkit/Pages/SalesInvoice/Widgets/pos-widget/newwidget.dart';
import 'package:sellerkit/Pages/SalesInvoice/Widgets/shorefdialog.dart';
...
class SalesNewController extends ChangeNotifier {
  int pageChanged = 0;
  ...
  List<SalesTypeData> ordertypedata = [];
  getLeveofType() async {
    leveofdata.clear();
    ordertypedata.clear();
    ...
    ordertypedata = await DBOperation.getordertypeDataSales(db);
    notifyListeners();
  }
...
//
  ...
  selectpaymentTerms(String selected, String refercode, String code,
    ...
    showDialog<dynamic>(
        context: context,
        builder: (_) {
          return paytermdialogSales(paymode: paymode);
        });
    // log("AN22:" + EnqRefer.toString());
...
// Navigator.pop(context);
    ...
    if (mycontroller[49].text.isNotEmpty) {
      for (int ij = 0; ij < allProductDetails.length; ij++) {
        if (allProductDetails[ij].itemCode!.toLowerCase() ==
            mycontroller[49].text.toLowerCase()) {
          itemAlreadyscanned = true;
          indexscanning = ij;
          notifyListeners();
          break;
...
// int linenum=0;
  ...
  callLeadPageSB(
    ...
    SalesTabController.comeFromEnq = checkEnqDetailsData[0].DocEntry!;
    SalesTabController.isSameBranch = true;
    Navigator.pop(context);
  ...
  callLeadPageNSB(BuildContext context) {
    SalesTabController.comeFromEnq = checkEnqDetailsData[0].DocEntry!;
    SalesTabController.isSameBranch = false;
    //  Navigator.pop(context);
    //  callApi();
    //  customerapicLoading = false;
    //  exceptionOnApiCall = '';
...
// FocusScope.of(context).unfocus();
  ...
  mapValues(GetCustomerData itemdata, BuildContext context) {
    ...
    mycontroller[19].text =
        itemdata.del_Address1 == null || itemdata.del_Address1!.isEmpty
            ? ""
            : itemdata.del_Address1.toString();
    mycontroller[20].text =
        itemdata.del_Address2 == null || itemdata.del_Address2!.isEmpty
            ? ""
            : itemdata.del_Address2.toString();
    mycontroller[21].text =
        itemdata.del_Area == null || itemdata.del_Area!.isEmpty
            ? ""
            : itemdata.del_Area.toString();
    mycontroller[22].text =
        itemdata.del_city == null || itemdata.del_city!.isEmpty
            ? ""
            : itemdata.del_city.toString();
    mycontroller[23].text =
        itemdata.del_pincode == null || itemdata.del_pincode!.isEmpty
            ? ""
...
//save all values tp server
  editcustdetail(BuildContext context) {
    mycontroller[19].text = customerdetails[0].del_Address1 == null ||
            customerdetails[0].del_Address1!.isEmpty
        ? ""
        : customerdetails[0].del_Address1.toString();
    mycontroller[20].text = customerdetails[0].del_Address2 == null ||
            customerdetails[0].del_Address2!.isEmpty
        ? ""
        : customerdetails[0].del_Address2.toString();
    mycontroller[21].text = customerdetails[0].del_Area == null ||
            customerdetails[0].del_Area!.isEmpty
        ? ""
        : customerdetails[0].del_Area.toString();
    mycontroller[22].text = customerdetails[0].del_city == null ||
            customerdetails[0].del_city!.isEmpty
        ? ""
        : customerdetails[0].del_city.toString();
    mycontroller[23].text = customerdetails[0].del_pincode == null ||
            customerdetails[0].del_pincode!.isEmpty
        ? ""
        : customerdetails[0].del_pincode.toString();

    mycontroller[1].text = customerdetails[0].contactName == null ||
            customerdetails[0].contactName!.isEmpty
        ? ""
        : customerdetails[0].contactName.toString();
    mycontroller[6].text = customerdetails[0].altermobileNo == null ||
            customerdetails[0].altermobileNo!.isEmpty
        ? ""
        : customerdetails[0].altermobileNo.toString();
    mycontroller[0].text = customerdetails[0].customerCode == null ||
            customerdetails[0].customerCode!.isEmpty
        ? ""
        : customerdetails[0].customerCode.toString();
    mycontroller[16].text = customerdetails[0].customerName == null ||
            customerdetails[0].customerName!.isEmpty
        ? ""
        : customerdetails[0].customerName.toString();
    mycontroller[2].text = customerdetails[0].Address_Line_1 == null ||
            customerdetails[0].Address_Line_1!.isEmpty
        ? ""
        : customerdetails[0].Address_Line_1.toString();

    mycontroller[3].text = customerdetails[0].Address_Line_2 == null ||
            customerdetails[0].Address_Line_2!.isEmpty
        ? ""
        : customerdetails[0].Address_Line_2.toString();
    mycontroller[4].text = customerdetails[0].Pincode == null ||
            customerdetails[0].Pincode!.isEmpty
        ? ""
        : customerdetails[0].Pincode.toString();
    mycontroller[5].text =
        customerdetails[0].City == null || customerdetails[0].City!.isEmpty
            ? ""
            : customerdetails[0].City.toString();
    mycontroller[17].text =
        customerdetails[0].area == null || customerdetails[0].area!.isEmpty
            ? ""
  ...
  savecustdetails() {
    ...
    customerdetails.add(GetCustomerData(
      ...
      customerCode: mycontroller[0].text == null || mycontroller[0].text.isEmpty
          ...
          : mycontroller[0].text,
      customerName:
          mycontroller[16].text == null || mycontroller[16].text.isEmpty
              ? null
              : mycontroller[16].text,
      Address_Line_1:
